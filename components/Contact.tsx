      ...
      <form className="my-8" action="https://formspree.io/f/mwpkvrqq" method="POST">
        {/* <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <LabelInputContainer>
            ...
            <Input id="firstname" name="first_name" placeholder="John" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" name="last_name" placeholder="Doe" type="text" />
          </LabelInputContainer>
        </div> */}
        ...
        <LabelInputContainer className="mb-4">
          ...
          {/* <textarea> */}
          <Input id="message" name="message" placeholder="" type="textarea" className="min-h-[15rem]" />
        </LabelInputContainer>
